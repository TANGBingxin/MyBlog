...
public class BaseService<TEntity> : IBaseService<TEntity> where TEntity:class,new()
{
    ...
    public async Task<List<TEntity>> QueryAsync(System.Linq.Expressions.Expression<Func<TEntity, bool>> func)
    {
    ...
    public async Task<List<TEntity>> QueryAsync(System.Linq.Expressions.Expression<Func<TEntity, bool>> func, int page, int size, RefAsync<int> total)
    {
